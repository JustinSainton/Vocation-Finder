...
export default function QuestionCategoriesIndex({ categories }: Props) {
    ...
    return (
        <AdminLayout title="Question Categories">
            <div className="flex items-center justify-between">
                <h1 className="font-serif text-2xl text-[var(--color-text)]">Question Categories</h1>
                <Link
                    href="/admin/question-categories/create"
                ...
                <tbody>
                    {categories.map((cat) => (
                        <tr key={cat.id} className="border-b border-[var(--color-border)]">
                            ...
                            <td className="py-3 text-[var(--color-text-secondary)]">{cat.questions_count}</td>
                            <td className="py-3">
                                <div className="flex gap-3">
                                    <Link
                                        href={`/admin/question-categories/${cat.id}/edit`}
