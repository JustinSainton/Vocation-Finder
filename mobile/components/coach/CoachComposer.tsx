...
export const COMPOSER_GUTTER = 24;
    ...
    <View style={[styles.container, { borderTopColor: colors.divider, backgroundColor: colors.background }]}>
      ...
      <View style={styles.row}>
        <TextInput
          ...
          style={[
            styles.input,
            { color: colors.text, borderColor: colors.divider, backgroundColor: colors.surface },
          ]}
        />
        <Pressable
...
const styles = StyleSheet.create({
  ...
  row: { flexDirection: 'row', alignItems: 'flex-end', gap: spacing.sm, paddingTop: spacing.sm },
  input: {
    flex: 1,
    minWidth: 0,
    minHeight: 44,
